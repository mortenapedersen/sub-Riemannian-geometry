...
def global_r_frame(point):
    ...
    returns: dictionary with 3 arrays, 'X','Y','Z'. Each array is the corresponding frame vector (see Donne).
o    """
...
## implementer mappet mellem R^3-repraesentationen og matrix-repr.: visse ting er lettere i sidstnaevnte.
